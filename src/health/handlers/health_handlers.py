...
from .._lib import (
    ...
    build_europe_hiv_transmission,
    build_us_autism,
    build_us_hiv_transmission,
...
_DISPATCH: dict[str, Any] = {
    ...
    f"{MAPS}.BuildEuropeHIVTransmissionMap": _wrap(build_europe_hiv_transmission, "BuildEuropeHIVTransmissionMap"),
    f"{MAPS}.BuildUSHIVTransmissionMap": _wrap(build_us_hiv_transmission, "BuildUSHIVTransmissionMap"),
    f"{MAPS}.BuildUSAutismMap": _wrap(build_us_autism, "BuildUSAutismMap"),
